...
export function preprocess(
  ...
  if (typeof input === 'string') {
    source = new Source(input, options.moduleName);
    ...
    source = new Source('', options.moduleName);
    ast = input;
  }
  ...
  let program = new TokenizerEventHandlers(source, entityParser).acceptTemplate(ast);
